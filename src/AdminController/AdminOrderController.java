    ...
    private void performOrderDeletion(Order order) {
        ...
        try (Connection conn = DatabaseHandler.getDBConnection()) {
            ...
            try (PreparedStatement deleteStmt = conn.prepareStatement(deleteQuery);
                ...
                // Parse quantity from the order (assuming it's stored as string)
                int quantityToReturn = Integer.parseInt(order.getQuantity());
                ...
                if (rowsDeleted > 0) {
                    ...
                    infoAlert.setContentText("Order ID " + order.getOrderId() + " deleted successfully.\n" +
                            ...
                            "Quantity " + quantityToReturn + " returned to product inventory.");
            ...
            e.printStackTrace();
            showErrorAlert("Data Error", "Invalid quantity format in order: " + order.getQuantity());
        }
    }
